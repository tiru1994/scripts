...
rem copyright (c) Ernst & Young LLP 2012
rem Refreshed by Deloitte Touche Tohmatsu India LLP (c) 2019
rem -------------------------------------------------------------
...
echo Copy these files to a EY consultant's encrypted USB storage such as an XKey.
echo Do not email these files!
echo ----------------------------------------------------------------------------
