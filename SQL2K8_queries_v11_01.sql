...
print ' '
print 'SQL2K8_10 Rename sa account'
print ' '
print ' '
select loginname from sys.syslogins
print ' '
print ' '
print 'SQL2K8_11 Sample Database'
print ' '
print ' '
select name from sys.sysdatabases 
print ' '
print 'SQL2K8_12 Initialization parameter-Remote Access Status'
print ' '
print ' '
exec sp_configure 'Remote access'
print ' '
print 'SQL2K8_13 Initialization parameter-Scan for Startup Procedures Status'
print ' '
print ' '
...
print ' '
print 'SQL2K8_18 Cross Database Ownership Chaining'
print ' '
exec sp_configure 'Cross db ownership'

print ' '
print 'SQL2K8_20 Replication '
print ' '
exec sp_configure 'Replication XPs'
print ' '
print ' '
print 'SQL2K8_22 Database Mail'
print ' '
print ' '
exec sp_configure'Database Mail XPs'
print ' '
print 'SQL2K8_24 Extended stored procedures'
print ' '
print ' '
...
print ' '
print 'SQL2K8_25 SQL mail extended stored procedure'
...
print 'SQL2K8_26 Web task extended stored procedures'
...
print 'SQL2K8_27 OLE Automation stored procedures'
...
print 'SQL2K8_28 Registry Access extended stored procedures'
...
print 'SQL2K8_29 - Critical stored procedures are not encrypted'
print ' '
print ' '
...
print ' '
print 'SQL2K8_32 SQL Logins'
print ' '
print ' '
select * from sys.sql_logins 
print ' '
print 'SQL2K8_33 OS Guests access'
print ' '
print ' '
select loginname, hasaccess from sys.syslogins 
print ' '
print 'SQL2K8_34  Fixed Server roles'
print ' '
print ' '
exec sp_helpsrvrolemember 
print ' '
print 'SQL2K8_35 Database Guest Account access to database'
print ' '
print ' '
exec sp_msforeachdb 
'use ? select ''?'', name, hasdbaccess from sys.sysusers where name = ''guest'''
print ' '
print 'SQL2K8_36 Users having “WITH GRANT” privilege'
print ' '
print ' '
...
print ' '
print ' '
print 'SQL2K8_37 Remote Server Status'
print ' '
print ' '
select * from sys.sysservers
print ' '
print 'SQL2K8_38 - Windows and SQL administration roles are not separated'
print ' '
print ' '
exec sp_helpsrvrolemember 
print ' '
...
print ' '
print ' '
print 'SQL2K8_39 - Database Roles'
print ' '
print ' '
EXEC sp_msforeachdb @command1='PRINT''DB Name - ?''',@command2="use ? EXEC sp_helprolemember"
print ' '
print 'SQL2K8_40 - Server Roles'
print ' '
print 'Server Roles:'
print ' '
exec sp_helpsrvrolemember 
print ' '
print 'SQL2K8_41 Statement Permissions are assigned to non-administrative users'
print ' '
print ' '
...
print ' '
print 'SQL2K8_43 Unrestricted access to System Tables'
print ' '
print ' '
...
print ' '
print 'SQL2K8_44 Ad Hoc Remote Queries'
print ' '
print ' '
select * from sys.configurations where name = 'Ad Hoc Distributed Queries'
print ' '
print 'SQL2K8_45 CLR Integration'
print ' '
print ' '
...
print '2.5.4 Ensure the public role in the msdb database is not granted access to SQL Agent proxies'
print ' '
