...
select '2.1.1. Insecure Oracle Database release' from dual;
...
col desc format a50
select '2.1.5. Set all default account passwords to non-default strong passwords' from dual;
...
col desc format a50
select '2.3.5. Http and ftp access to the oracle database' from dual;
