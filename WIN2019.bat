Echo ############################################################################################## 	>> output.txt
Echo       Deloitte Windows server 2019 Configuration Interrogation Script              	>> output.txt
...
Echo ############################################################################################## 	>> output.txt
Echo Executing the WIN2019.bat file............								>> output.txt
Echo. >> output.txt		
...
Echo. >> output.txt
FIND/i "complexity requirements" passwordpolicy.txt >> output.txt
Echo. >> output.txt
...
Echo ===========================================>> output.txt
Echo 1.2 SET CLIENT CONNECTION ENCRYPTION LEVEL >> output.txt
Echo ===========================================>> output.txt
Echo The recommended Value of following registry key should be set to 3 >> output.txt
Echo. >> output.txt
Echo -Security Layer 1 – With a low security level, only the communications sent from the client to the server are  encrypted using 56-bit encryption. >> output.txt
Echo -Security Layer 2 – Having a client compatible security level, communications between the server and the client are encrypted at the maximum key strength supported by the client.>> output.txt
Echo -Security Layer 3 – With a high security level, communications between server and client are encrypted using 128-bit encryption.  >> output.txt
Echo. >> output.txt
...
Echo ========================================================================================= >> output.txt
Echo 1.3 User sessions that are inactive for a set amount of time should have their session disabled >> output.txt
Echo ========================================================================================= >> output.txt
REG QUERY "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services\MaxIdleTime" >> output.txt
Echo. >> output.txt

Echo ====================================================>>  output.txt
Echo 1.4  Unnecessary network protocols should be removed >> output.txt
Echo ==================================================== >> output.txt
Echo Manual check >> output.txt
Echo. >> output.txt

Echo ================================================================== >> output.txt
Echo 1.5 A legal notice and warning should be implemented on the server >> output.txt
Echo ================================================================== >> output.txt
...
Echo ==================================================================================================== >> output.txt
Echo 4.4. Auditing of sensitive system and application files and directories should be enabled for servers>> output.txt
Echo ==================================================================================================== >> output.txt
Echo Manual check >> output.txt
Echo. >> output.txt

Echo ================================================================================ >> output.txt
Echo 4.5. Auditing of sensitive system registry keys should be enabled on servers>> output.txt
Echo ================================================================================ >> output.txt
Echo Manual check >> output.txt
Echo. >> output.txt
...
Echo ===================================>> output.txt
Echo. >> output.txt
find /I "Apply UAC restrictions to local accounts" admtemplate.csv >> output.txt
Echo If output is not returned then parameter is not configured >> output.txt
Echo. >> output.txt
...
Echo ========================= >> output.txt
Echo 10. Kernal DMA Protection >> output.txt
Echo ========================= >> output.txt

Echo ============================================================================================================================ >> output.txt
Echo 10.1. Ensure 'Enumeration policy for external devices incompatible with Kernel DMA Protection' is set to 'Enabled: Block All' >> output.txt
Echo ============================================================================================================================ >> output.txt
Echo. >> output.txt		
FIND /i "DMA Protection" admtemplates.txt >> output.txt
REG QUERY "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Kernel DMA Protection:DeviceEnumerationPolicy" >> output.txt
Echo. >> output.txt
